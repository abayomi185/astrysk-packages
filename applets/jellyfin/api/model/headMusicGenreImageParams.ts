...
export type HeadMusicGenreImageParams = { tag?: string; format?: ImageFormat; maxWidth?: number; maxHeight?: number; percentPlayed?: number; unplayedCount?: number; width?: number; height?: number; quality?: number; fillWidth?: number; fillHeight?: number; cropWhitespace?: boolean; addPlayedIndicator?: boolean; blur?: number; backgroundColor?: string; foregroundLayer?: string; imageIndex?: number };
